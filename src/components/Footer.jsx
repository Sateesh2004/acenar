  ...
  return (
    <footer className="bg-[#002147] text-white pt-24 pb-12 px-6 overflow-hidden relative">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-16 relative z-10">
          ...
          <div className="flex gap-3">
            {socials.map(({ name, href, icon: Icon }) => (
              <Link
                ...
                className="w-10 h-10 border border-white/20 rounded-full flex items-center justify-center hover:bg-[#CCFF00] hover:text-[#002147] transition-all"
              >
        ...
        <div>
          <h4 className="text-[#CCFF00] font-black uppercase text-xs tracking-[0.2em] mb-8">
            Corporate
          </h4>
          ...
          >
            ...
            <li  onClick={() => alert("We do not have any openings yet.")} className="hover:text-white cursor-pointer transition-colors">
              Careers
            </li>
          </ul>
        </div>
        <div>
          ...
          <div className="space-y-6 text-sm text-slate-400">
            <div className="flex items-start space-x-3">
              ...
              <span>
                Plot No.-543 N, Pace City-II, Sector-37, Gurugram (Haryana)
              </span>
            </div>
