     ...
     <section className="py-32 bg-white">
      <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-3 gap-16">
        {[
          ...
          { icon: <Award />, title: "No Quality, No Order", desc: "Strict adherence to our core philosophy of zero-defect production." },
        ].map((item, idx) => (
          <div key={idx} className="group cursor-default">
            <div className="w-16 h-16 rounded-2xl bg-slate-50 flex items-center justify-center text-[#002147] mb-8 group-hover:bg-[#CCFF00] transition-all duration-500 group-hover:-translate-y-2">
              {item.icon}
            </div>
