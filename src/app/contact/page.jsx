              ...
              <div>
                ...
                <div className="grid gap-12">
                  <div className="flex items-center space-x-8">
                    <div className="text-5xl font-black text-[#dea764]/40">01</div>
                    <div>
                  ...
                  <div className="flex items-center space-x-8">
                    <div className="text-5xl font-black text-[#dea764]/40">02</div>
                    <div>
              ...
              <div className="bg-[#002147] p-12 md:p-16 rounded-[4rem] shadow-2xl relative">
                {submitted ? (
                  <div className="py-20 text-center animate-in zoom-in duration-500">
                    <div className="w-24 h-24 bg-[#dea764] rounded-full flex items-center justify-center mx-auto mb-10 text-[#002147]">
                    ...
                    <button onClick={() => setSubmitted(false)} className="text-[#dea764] font-black uppercase text-xs tracking-widest border-b-2 border-[#dea764] pb-1">New Request</button>
                  </div>
                ) : (
                  <form className="space-y-10" onSubmit={(e) => { e.preventDefault(); setSubmitted(true); }}>
                    <div className="space-y-10">
                      <div className="group border-b border-white/20 focus-within:border-[#dea764] transition-colors">
                    ...
                    <button type="submit" className="w-full bg-[#dea764] text-[#002147] py-6 rounded-3xl font-black uppercase tracking-[0.2em] text-xs hover:scale-[1.02] transition-transform active:scale-95 shadow-xl shadow-[#dea764]/10">
